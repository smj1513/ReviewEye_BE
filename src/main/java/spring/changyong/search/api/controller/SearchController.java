...
public class SearchController implements SearchDocsController {
	...
	public CommonResponse<SearchResponse.Result<SearchResponse.ReviewResult>> searchReview(@PathVariable String id,
		...
		return CommonResponse.success(SuccessCode.OK, searchService.searchReviewByProductId(id, URLDecoder.decode(keyword, StandardCharsets.UTF_8), page, size, filter, sortOption, orderBy));
	}
